...
class AddPropertyComponent extends Component
{
                    ...
                    (props) =>(
                        <Form>
                             <div class="form-icon">
                                ...
                                <h1 style={{marginBottom: 50, fontWeight: "bold"}}>Add new property</h1>
                            ...
                            <button className="btn btn-block create-account" type = "submit">App Property</button>
                        </Form>
                    )
                }
            </Formik>
    ...
    onSubmit(values)
    {
        ...
        .then(() => {this.props.navigate(`/properties`)})
    }
}
